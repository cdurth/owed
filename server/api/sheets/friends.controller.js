...
exports.create = function(req, res) {
	...
	var friendEntry = new FriendsModel();
...
exports.read = function(req, res) {
	...
	var query = FriendsModel.findOne({sheet_id: sheet_id, _id: friend_id});
...
exports.update = function(req, res) {
	...
	FriendsModel.update({sheet_id: friend.sheet_id, _id: friend._id},
		updateFriend,
...
exports.delete = function(req, res) {
	...
	Async.series(
		[
			...
			function(callback) {
				var query = ExpensesModel.find({sheet_id: sheet_id, paid_by: friend_id});
			...
			function(callback) {
				var query = ExpensesModel.find({sheet_id: sheet_id, paid_for: friend_id});
				query.exec(function(err, expenses) {
					if (err) {
						callback(err);
					}
